...
export const MegaphoneIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V4.734a1.734 1.734 0 013.468 0v1.148M11 5.882a1.734 1.734 0 00-3.468 0v6.866a1.734 1.734 0 003.468 0V5.882z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882l.006.002a1.734 1.734 0 012.582 1.405l.334 5.342a1.734 1.734 0 01-1.637 1.954H9.715a1.734 1.734 0 01-1.637-1.954l.334-5.342a1.734 1.734 0 012.582-1.405L11 5.882zM15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const PaletteIcon: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className = 'w-6 h-6', style }) => (
...
export const FileWarningIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const AppearanceIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118v-.09A12.025 12.025 0 01 2.022 12c0-3.037 1.21-5.79 3.22-7.778a11.964 11.964 0 014.54-2.118v.09A2.25 2.25 0 019.53 3.55z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 12c0 3.037-1.21 5.79-3.22 7.778a11.964 11.964 0 01-4.54 2.118v-.09a2.25 2.25 0 01-2.47-2.118 3 3 0 00-5.78-1.128 2.25 2.25 0 01-2.47-2.118v-.09A12.025 12.025 0 01 2.022 12c0-3.037 1.21-5.79 3.22-7.778a11.964 11.964 0 014.54-2.118v.09a2.25 2.25 0 012.47 2.118 3 3 0 005.78 1.128 2.25 2.25 0 012.47 2.118v.09A12.025 12.025 0 0121.75 12z" />
    </svg>
);

export const SimpleBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="16" height="16" rx="4" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

export const RefinedBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="16" height="16" rx="4" stroke="currentColor" strokeWidth="2.5"/>
  </svg>
);

export const GradientBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <rect x="4" y="4" width="16" height="16" rx="4" stroke="url(#grad)" strokeWidth="2"/>
  </svg>
);

export const NeonBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const AccentBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 8C4 5.79086 5.79086 4 8 4H16C18.2091 4 20 5.79086 20 8V16C20 18.2091 18.2091 20 16 20H8C5.79086 20 4 18.2091 4 16V8Z" stroke="currentColor" strokeOpacity="0.3" strokeWidth="1.5"/>
    <path d="M4 8C4 5.79086 5.79086 4 8 4H16C18.2091 4 20 5.79086 20 8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
  </svg>
);

export const DoubleBorderIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" y="4" width="16" height="16" rx="4" stroke="currentColor" strokeWidth="1.5"/>
        <rect x="6.5" y="6.5" width="11" height="11" rx="2" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.5"/>
    </svg>
);

export const TypeIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 7V6a2 2 0 012-2h12a2 2 0 012 2v1M6 7h12M9 7v11a2 2 0 002 2h2a2 2 0 002-2V7" />
    </svg>
);
...
export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A12.02 12.02 0 0012 21.944a12.02 12.02 0 009-1.055A12.02 12.02 0 0021 8.944c0-1.763-.38-3.415-1.055-4.96z" />
    </svg>
);
...
export const StickyNoteIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" />
    </svg>
);
...
export const Edit3Icon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const PinIcon: React.FC<{ className?: string, isFilled?: boolean }> = ({ className = 'w-6 h-6', isFilled = false }) => (
...
export const QRIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 10h-3v3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 10H4" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 7V4" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 7V4" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 17v3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 14v-1" />
